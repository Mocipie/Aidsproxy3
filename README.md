...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Mocipie/Aidsproxy3/tree/main)
...
```sh
git clone https://github.com/Mocipie/Aidsproxy3
cd Incognito
npm install
npm start
```
